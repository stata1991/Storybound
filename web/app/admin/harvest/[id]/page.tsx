            ...
            {storyComplete && !illustrationsComplete && photosDeletedNoIllustrations && (
              <div>
                <div className="mb-3 rounded bg-amber-50 px-4 py-3 text-sm text-amber-700">
                  ...
                  <p className="mt-1">
                    Skip-LoRA recovery is not available. Contact support if this
                    harvest needs to be re-processed.
                  </p>
                </div>
              </div>
            )}
                  ...
                  <div>
                    <div className="mb-3 rounded bg-amber-50 px-4 py-3 text-sm text-amber-700">
                      ...
                      <p className="mt-1">
                        ...
                        skip-LoRA recovery is not available. Contact support if
                        this harvest needs to be re-processed.
                      </p>
                    </div>
                  </div>
                ) : (
