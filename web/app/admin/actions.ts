...
> {
  ...
  // Auth is this wrapper's job; the core carries none (see lib/print-orders).
  return placePrintOrder({
    supa: getAdmin(),
    episodeId,
    recipient,
    shippingMethod,
